...
.institution-body table { width: 100%; border-collapse: collapse; font-size: 0.95rem; }
.institution-body table thead tr { background-color: #f2f2f2; }
.institution-body table th { text-align: left; padding: 0.5rem 0.8rem; font-weight: 600; color: #4C0000; border-bottom: 2px solid #ccc; }
.institution-body table td { padding: 0.5rem 0.8rem; border-bottom: 1px solid #ebebeb; vertical-align: middle; }
.institution-body table tr:last-child td { border-bottom: none; }
.institution-body table tr:hover td { background-color: #fdf6f6; }
...
@media (prefers-color-scheme: dark) {
  ...
  .institution-header h3 { color: #f0f0f0; }
  .institution-header { border-bottom-color: #444; }
  .institution-body table thead tr { background-color: #2a2a2a; }
  .institution-body table th { color: #f0a0a0; border-bottom-color: #555; }
  .institution-body table td { border-bottom-color: #333; }
  .institution-body table tr:hover td { background-color: #2a2020; }
}
