...
* Note: Past course offerings can be verified via the <a href="https://lwus.statistik.tu-dortmund.de/en/teaching/courses/" target="_blank">TU Dortmund department archives</a> (listed under the name <strong>S. Hossain</strong>).
</p>

| Course | Role | Term(s) | Links |
|--------|------|---------|-------|
| Programming with Julia | Instructor | Winter Semester 2019/20 (Cancelled due to Covid - 19)<br>Winter Semester 2020/21 | [Materials](julia_course.qmd) |
