...
Economists often think about these problems, try to find useful numbers or **statistics** (for example the number 64 is statistic, called sample proportion), analyze these numbers, and finally try to solve these problems at the policy level. So, **these numbers / statistics are important and also Statistics as a subject is important!**
...
- Here are some nice materials from Professor John Levendis at Loyola University of New Orleans. 
  ...
  -He took a course on Business Statistics and recorded his lectures. Check the [complete playlist](https://www.youtube.com/playlist?list=PLVTgxfhzvMsUtEMtIine6BG2_ZRDg_cq7)
